...
csvwrite('LAOS_strain_serial.csv', strain);
csvwrite('LAOS_stressAmplitude_serial.csv', stressAmplitude);
csvwrite('LAOS_I31_serial.csv', I31);
csvwrite('LAOS_runtime_serial.csv', run_time);